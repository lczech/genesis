...
void genesis_util_bit_bitvector_add_ons(
    pybind11::class_<
        genesis::util::bit::Bitvector,
        std::shared_ptr<genesis::util::bit::Bitvector>
    > &cl
) {
    ...
    cl.def(
        pybind11::init(
            ...
            {
                return ::genesis::util::bit::Bitvector(input.begin(), input.end());
            }
        ),
        pybind11::arg("values")
    );
    ...
    cl.def(
        "__len__",
        []( ::genesis::util::bit::Bitvector const& self )
        {
            return self.size();
        }
    );
    cl.def(
        "__setitem__",
        []( ::genesis::util::bit::Bitvector& self, size_t i, bool v )
        {
            return self.set(i, v);
        },
        py::arg("index"),
    ...
    cl.def(
        "__and__",
        []( ::genesis::util::bit::Bitvector &self, ::genesis::util::bit::Bitvector const& rhs )
        {
            return self & rhs;
        },
        pybind11::arg("rhs")
