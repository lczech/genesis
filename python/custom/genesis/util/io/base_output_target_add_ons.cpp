...
void genesis_util_io_base_output_target_add_ons(
    pybind11::class_<
    ...
    cl.def("__enter__",
        []( std::shared_ptr<genesis::util::io::BaseOutputTarget> self )
            -> std::shared_ptr<genesis::util::io::BaseOutputTarget>
        {
            return self;
        },
    ...
    auto string_target_getter = [](
        ...
        if( self ) {
            ...
            auto s = dynamic_cast<genesis::util::io::StringOutputTarget*>( self.get() );
            if( s ) {
