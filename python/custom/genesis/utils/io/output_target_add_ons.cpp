...
void genesis_utils_io_output_target_add_ons(py::module &m)
{
    // ---------------------------------------------------------------------
    //   Buffer Holder
    // ---------------------------------------------------------------------
    ...
    struct BufferHolder {
        ...
        std::shared_ptr<genesis::utils::io::BaseOutputTarget> target_ref;
        ...
        void set_target(std::shared_ptr<genesis::utils::io::BaseOutputTarget> target)
        {
            target_ref = target;
        }
    };
    ...
    auto make_python_buffer_target_ = [](
        py::object dest,
        genesis::utils::io::GzipCompressionLevel compression_level
        ...
        auto original_target = genesis::utils::io::to_stream(
            holder_sp->stream,
            compression_level
        );
        ...
        std::shared_ptr<genesis::utils::io::BaseOutputTarget> ret(
            original_target.get(),
            [holder_sp, original_target](genesis::utils::io::BaseOutputTarget*) mutable
            {
        ...
        // if( compression_level != genesis::utils::io::GzipCompressionLevel::kNoCompression ) {
        ...
        //     return genesis::utils::io::to_file(
        //         path,
        //         compression_level,
        //         false
        //     );
    ...
    static std::string const to_file_doc =
        ...
        "\n\n\n\n\n\n\n\nC++: genesis::utils::io::to_file(const std::string &, enum "
        "genesis::utils::io::GzipCompressionLevel, bool) --> class std::shared_ptr<class "
    ...
    m.def("to_file",
        [to_file_binder_](
            ...
            return to_file_binder_(
                dest,
                genesis::utils::io::GzipCompressionLevel::kNoCompression
            );
        },
        py::arg("dest"),
        to_file_doc.c_str()
    ...
    m.def("to_string",
        []() -> std::shared_ptr<genesis::utils::io::BaseOutputTarget>
        {
            return genesis::utils::io::to_string();
        },
