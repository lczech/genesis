...
{
    // genesis::utils::current_date() file:genesis/utils/tool/date_time.hpp line:48
    // function-signature: std::string genesis::utils::current_date()()
    // file:genesis/utils/tool/date_time.hpp line:48
    M( "genesis::utils" )
        .def(
            "current_date",
    ...
    // genesis::utils::current_time() file:genesis/utils/tool/date_time.hpp line:53
    // function-signature: std::string genesis::utils::current_time()()
    // file:genesis/utils/tool/date_time.hpp line:53
    M( "genesis::utils" )
        .def(
            "current_time",
