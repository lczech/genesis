...
{
    { // genesis::utils::Tickmarks file:genesis/utils/tool/tickmarks.hpp line:48
        ...
        // file:genesis/utils/tool/tickmarks.hpp line:71
        ...
        // file:genesis/utils/tool/tickmarks.hpp line:74
        ...
        // struct genesis::utils::Tickmarks &) file:genesis/utils/tool/tickmarks.hpp line:77
        cl.def(
            "assign",
        ...
        // long)(double, unsigned long) file:genesis/utils/tool/tickmarks.hpp line:91
        cl.def_static(
            "step_size",
        ...
        // unsigned long) file:genesis/utils/tool/tickmarks.hpp line:99
        cl.def(
            "linear_ticks",
        ...
        // unsigned long) file:genesis/utils/tool/tickmarks.hpp line:109
        cl.def(
            "linear_labels",
            ( class std::vector<
        ...
        // double) file:genesis/utils/tool/tickmarks.hpp line:125
        cl.def(
            "logarithmic_labels",
        ...
        { // genesis::utils::Tickmarks::LabeledTick file:genesis/utils/tool/tickmarks.hpp line:56
            ...
            // double)(double, double) file:genesis/utils/tool/tickmarks.hpp line:58
            cl.def(
