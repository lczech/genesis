...
)
{
    { // genesis::utils::io::FileInputSource file:genesis/utils/io/file_input_source.hpp line:61
        ...
        // function-signature: genesis::utils::io::FileInputSource::FileInputSource(const class
        // genesis::utils::io::FileInputSource &)(const class genesis::utils::io::FileInputSource &)
        // file:genesis/utils/io/file_input_source.hpp line:95
        cl.def( pybind11::init( []( genesis::utils::io::FileInputSource const& o ) {
            return new genesis::utils::io::FileInputSource( o );
        } ) );
        // function-signature: class genesis::utils::io::FileInputSource &
        // genesis::utils::io::FileInputSource::operator=(const class
        // genesis::utils::io::FileInputSource &)(const class genesis::utils::io::FileInputSource &)
        // file:genesis/utils/io/file_input_source.hpp line:98
        cl.def(
            "assign",
            ( class genesis::utils::io::FileInputSource &
              (genesis::utils::io::FileInputSource::*)(const class genesis::utils::io::
                                                           FileInputSource&)) &
                genesis::utils::io::FileInputSource::operator=,
    ...
    { // genesis::utils::io::StringInputSource file:genesis/utils/io/string_input_source.hpp line:60
        ...
        // function-signature: genesis::utils::io::StringInputSource::StringInputSource(const class
        // genesis::utils::io::StringInputSource &)(const class
        // genesis::utils::io::StringInputSource &) file:genesis/utils/io/string_input_source.hpp
        // line:109
        cl.def( pybind11::init( []( genesis::utils::io::StringInputSource const& o ) {
            return new genesis::utils::io::StringInputSource( o );
        } ) );
        // function-signature: class genesis::utils::io::StringInputSource &
        // genesis::utils::io::StringInputSource::operator=(const class
        // genesis::utils::io::StringInputSource &)(const class
        // genesis::utils::io::StringInputSource &) file:genesis/utils/io/string_input_source.hpp
        // line:112
        cl.def(
            ...
            ( class genesis::utils::io::StringInputSource &
              (genesis::utils::io::StringInputSource::*)(const class genesis::utils::io::
                                                             StringInputSource&)) &
                genesis::utils::io::StringInputSource::operator=,
    ...
    // genesis::utils::io::BaseInputSource>) file:genesis/utils/io/functions.hpp line:53
    ...
    // genesis::utils::io::BaseInputSource>) file:genesis/utils/io/functions.hpp line:61
