...
void bind_genesis_utils_io_file_input_source(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// genesis::utils::io::from_string(const std::string &) file:genesis/utils/io/input_source.hpp line:144
	// function-signature: class std::shared_ptr<class genesis::utils::io::BaseInputSource> genesis::utils::io::from_string(const std::string &)(const std::string &) file:genesis/utils/io/input_source.hpp line:144
	M("genesis::utils::io").def("from_string", (class std::shared_ptr<class genesis::utils::io::BaseInputSource> (*)(const std::string &)) &genesis::utils::io::from_string, "Obtain an input source for reading from a `std::string`.\n\n The input source returned from this function can be used in the reader classes, e.g.,\n placement::JplaceReader or sequence::FastaReader.\n\n \n See from_file(), from_files(), from_strings(), and from_stream() for similar\n helper functions for other types of input sources.\n\nC++: genesis::utils::io::from_string(const std::string &) --> class std::shared_ptr<class genesis::utils::io::BaseInputSource>", pybind11::arg("input_string"));

	// genesis::utils::io::from_string(const char *) file:genesis/utils/io/input_source.hpp line:203
	// function-signature: class std::shared_ptr<class genesis::utils::io::BaseInputSource> genesis::utils::io::from_string(const char *)(const char *) file:genesis/utils/io/input_source.hpp line:203
	M("genesis::utils::io").def("from_string", (class std::shared_ptr<class genesis::utils::io::BaseInputSource> (*)(const char *)) &genesis::utils::io::from_string, "Obtain an input source for reading from a string literal.\n\n This overload is needed as otherwise, the other overloads of this function are ambiguous\n when called with a string literal.\n\n The input source returned from this function can be used in the reader classes, e.g.,\n placement::JplaceReader or sequence::FastaReader.\n\n \n See from_file(), from_files(), from_strings(), and from_stream() for similar\n helper functions for other types of input sources.\n\nC++: genesis::utils::io::from_string(const char *) --> class std::shared_ptr<class genesis::utils::io::BaseInputSource>", pybind11::arg("input_string"));
