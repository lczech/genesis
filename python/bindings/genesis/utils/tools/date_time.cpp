...
)
{
    ...
    { // genesis::utils::GeoCoordinate file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:46
        ...
        // file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:54
        ...
        // double) file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:56
        ...
        // file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:64
        ...
        // file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:67
        cl.def(
            "assign",
        ...
        // file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:77
        cl.def(
            "latitude",
        ...
        // file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:85
        cl.def(
            "longitude",
            ( double( genesis::utils::GeoCoordinate::* )() const ) &
        ...
        // file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:93
        cl.def(
            "latitude",
        ...
        // file:genesis/utils/tools/geodesy/geo_coordinate.hpp line:105
        cl.def(
            "longitude",
            ( class genesis::utils::GeoCoordinate & (genesis::utils::GeoCoordinate::*)(double)) &
                genesis::utils::GeoCoordinate::longitude,
    ...
    // file:genesis/utils/tools/geodesy/functions.hpp line:68 function-signature: std::string
    // genesis::utils::sanitize_geo_coordinate(const std::string &, bool)(const std::string &, bool)
    // file:genesis/utils/tools/geodesy/functions.hpp line:68
    M( "genesis::utils" )
        .def(
    ...
    // file:genesis/utils/tools/geodesy/functions.hpp line:76 function-signature: class
    // genesis::utils::GeoCoordinate genesis::utils::convert_geo_coordinate(const std::string &,
    // const std::string &)(const std::string &, const std::string &)
    // file:genesis/utils/tools/geodesy/functions.hpp line:76
    M( "genesis::utils" )
        .def(
    ...
    // file:genesis/utils/tools/geodesy/functions.hpp line:111 function-signature: class
    // genesis::utils::GeoCoordinate genesis::utils::convert_geo_coordinate(const std::string
    // &)(const std::string &) file:genesis/utils/tools/geodesy/functions.hpp line:111
    M( "genesis::utils" )
        .def(
            "convert_geo_coordinate",
    ...
    // genesis::utils::GeoCoordinate &) file:genesis/utils/tools/geodesy/functions.hpp line:124
    ...
    // genesis::utils::GeoCoordinate &, const class genesis::utils::GeoCoordinate &)
    // file:genesis/utils/tools/geodesy/functions.hpp line:124
    M( "genesis::utils" )
        .def(
            "geo_distance",
    ...
    // enum genesis::utils::HashingFunctions) file:genesis/utils/tools/hash/functions.hpp line:81
    ...
    // genesis::utils::HashingFunctions) file:genesis/utils/tools/hash/functions.hpp line:81
    M( "genesis::utils" )
        .def(
            "hash_hex",
            ( std::string( * )(
    ...
    { // genesis::utils::MD5 file:genesis/utils/tools/hash/md5.hpp line:88
        ...
        // function-signature: genesis::utils::MD5::MD5()() file:genesis/utils/tools/hash/md5.hpp
        // line:117
        ...
        // class genesis::utils::MD5 &) file:genesis/utils/tools/hash/md5.hpp line:120
        ...
        // file:genesis/utils/tools/hash/md5.hpp line:123
        cl.def(
            "assign",
        ...
        // genesis::utils::io::BaseInputSource>) file:genesis/utils/tools/hash/md5.hpp line:133
        cl.def_static(
            "read_hex",
        ...
        // genesis::utils::io::BaseInputSource>)(class std::shared_ptr<class
        // genesis::utils::io::BaseInputSource>) file:genesis/utils/tools/hash/md5.hpp line:138
        cl.def_static(
            "read_digest",
            ( struct std::array<
                unsigned char,
        ...
        // file:genesis/utils/tools/hash/md5.hpp line:140
        cl.def_static(
            "digest_to_hex",
        ...
        // file:genesis/utils/tools/hash/md5.hpp line:141
        cl.def_static(
            "hex_to_digest",
        ...
        // file:genesis/utils/tools/hash/md5.hpp line:150
        cl.def(
            "clear",
        ...
        // genesis::utils::io::BaseInputSource>)(class std::shared_ptr<class
        // genesis::utils::io::BaseInputSource>) file:genesis/utils/tools/hash/md5.hpp line:152
        cl.def(
            "update",
        ...
        // std::string &) file:genesis/utils/tools/hash/md5.hpp line:153
        cl.def(
            "update",
        ...
        // char *, unsigned int) file:genesis/utils/tools/hash/md5.hpp line:155
        cl.def(
            "update",
        ...
        // file:genesis/utils/tools/hash/md5.hpp line:160
        cl.def(
            "final_hex",
        ...
        // function-signature: struct std::array<unsigned char, 16>
        // genesis::utils::MD5::final_digest()() file:genesis/utils/tools/hash/md5.hpp line:165
        cl.def(
            "final_digest",
