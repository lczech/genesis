...
void bind_genesis_utils_core_fs(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// function-signature: bool genesis::utils::is_file(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:57
	...
	// function-signature: bool genesis::utils::file_exists(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:64
	...
	// function-signature: bool genesis::utils::file_is_readable(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:75
	...
	// function-signature: bool genesis::utils::file_is_readable(const std::string &, std::string &)(const std::string &, std::string &) file:genesis/utils/core/fs.hpp line:83
	...
	// function-signature: std::string genesis::utils::file_read(const std::string &, bool)(const std::string &, bool) file:genesis/utils/core/fs.hpp line:93
	...
	// function-signature: class std::vector<std::string > genesis::utils::file_read_lines(const std::string &, bool)(const std::string &, bool) file:genesis/utils/core/fs.hpp line:106
	M("genesis::utils").def("file_read_lines", [](const std::string & a0) -> std::vector<std::string > { return genesis::utils::file_read_lines(a0); }, "", pybind11::arg("filename"));
	M("genesis::utils").def("file_read_lines", (class std::vector<std::string > (*)(const std::string &, bool)) &genesis::utils::file_read_lines, "Return the contents of a file as a vector of strings, one entry for each line.\n\n If the parameter  is `true` (default), it is first determined whether the\n file is gzip compressed, and if so, the file is decompressed when reading.\n\n If the file is not readable, the function throws `std::runtime_error`.\n\nC++: genesis::utils::file_read_lines(const std::string &, bool) --> class std::vector<std::string >", pybind11::arg("filename"), pybind11::arg("detect_compression"));

	// genesis::utils::file_write(const std::string &, const std::string &, bool) file:genesis/utils/core/fs.hpp line:119
	// function-signature: void genesis::utils::file_write(const std::string &, const std::string &, bool)(const std::string &, const std::string &, bool) file:genesis/utils/core/fs.hpp line:119
	...
	// function-signature: void genesis::utils::file_append(const std::string &, const std::string &, bool)(const std::string &, const std::string &, bool) file:genesis/utils/core/fs.hpp line:130
	...
	// function-signature: bool genesis::utils::is_dir(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:146
	...
	// function-signature: bool genesis::utils::dir_exists(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:151
	...
	// function-signature: void genesis::utils::dir_create(const std::string &, bool)(const std::string &, bool) file:genesis/utils/core/fs.hpp line:160
	...
	// function-signature: std::string genesis::utils::dir_normalize_path(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:165
	...
	// function-signature: class std::vector<std::string > genesis::utils::dir_list_contents(const std::string &, bool, const std::string &)(const std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:175
	M("genesis::utils").def("dir_list_contents", [](const std::string & a0) -> std::vector<std::string > { return genesis::utils::dir_list_contents(a0); }, "", pybind11::arg("dir"));
	M("genesis::utils").def("dir_list_contents", [](const std::string & a0, bool const & a1) -> std::vector<std::string > { return genesis::utils::dir_list_contents(a0, a1); }, "", pybind11::arg("dir"), pybind11::arg("full_path"));
	M("genesis::utils").def("dir_list_contents", (class std::vector<std::string > (*)(const std::string &, bool, const std::string &)) &genesis::utils::dir_list_contents, "Get a list of files and directories in a directory.\n\n If  is set to `true`, the path of the provided  is prepended to the resulting\n list. If a non-empy  is provided, file names are filtered by this regular expression.\n\n If the directory is not readable, the function throws `std::runtime_error`.\n\nC++: genesis::utils::dir_list_contents(const std::string &, bool, const std::string &) --> class std::vector<std::string >", pybind11::arg("dir"), pybind11::arg("full_path"), pybind11::arg("regex"));

	// genesis::utils::dir_list_files(const std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:187
	// function-signature: class std::vector<std::string > genesis::utils::dir_list_files(const std::string &, bool, const std::string &)(const std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:187
	M("genesis::utils").def("dir_list_files", [](const std::string & a0) -> std::vector<std::string > { return genesis::utils::dir_list_files(a0); }, "", pybind11::arg("dir"));
	M("genesis::utils").def("dir_list_files", [](const std::string & a0, bool const & a1) -> std::vector<std::string > { return genesis::utils::dir_list_files(a0, a1); }, "", pybind11::arg("dir"), pybind11::arg("full_path"));
	M("genesis::utils").def("dir_list_files", (class std::vector<std::string > (*)(const std::string &, bool, const std::string &)) &genesis::utils::dir_list_files, "Get a list of files in a directory.\n\n Behaves the same as dir_list_contents(), except tat only files are listed (i.e., no directories).\n See there for an explanation of the arguments.\n\nC++: genesis::utils::dir_list_files(const std::string &, bool, const std::string &) --> class std::vector<std::string >", pybind11::arg("dir"), pybind11::arg("full_path"), pybind11::arg("regex"));

	// genesis::utils::dir_list_directories(const std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:199
	// function-signature: class std::vector<std::string > genesis::utils::dir_list_directories(const std::string &, bool, const std::string &)(const std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:199
	M("genesis::utils").def("dir_list_directories", [](const std::string & a0) -> std::vector<std::string > { return genesis::utils::dir_list_directories(a0); }, "", pybind11::arg("dir"));
	M("genesis::utils").def("dir_list_directories", [](const std::string & a0, bool const & a1) -> std::vector<std::string > { return genesis::utils::dir_list_directories(a0, a1); }, "", pybind11::arg("dir"), pybind11::arg("full_path"));
	M("genesis::utils").def("dir_list_directories", (class std::vector<std::string > (*)(const std::string &, bool, const std::string &)) &genesis::utils::dir_list_directories, "Get a list of directories in a directory.\n\n Behaves the same as dir_list_contents(), except tat only directories are listed (i.e., no files).\n See there for an explanation of the arguments.\n\nC++: genesis::utils::dir_list_directories(const std::string &, bool, const std::string &) --> class std::vector<std::string >", pybind11::arg("dir"), pybind11::arg("full_path"), pybind11::arg("regex"));

	// genesis::utils::current_path() file:genesis/utils/core/fs.hpp line:217
	// function-signature: std::string genesis::utils::current_path()() file:genesis/utils/core/fs.hpp line:217
	...
	// function-signature: std::string genesis::utils::real_path(const std::string &, bool)(const std::string &, bool) file:genesis/utils/core/fs.hpp line:227
	...
	// function-signature: class std::unordered_map<std::string, std::string > genesis::utils::file_info(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:236
	M("genesis::utils").def("file_info", (class std::unordered_map<std::string, std::string > (*)(const std::string &)) &genesis::utils::file_info, "Return information about a file.\n\nC++: genesis::utils::file_info(const std::string &) --> class std::unordered_map<std::string, std::string >", pybind11::arg("filename"));

	// genesis::utils::file_size(const std::string &) file:genesis/utils/core/fs.hpp line:241
	// function-signature: unsigned long genesis::utils::file_size(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:241
