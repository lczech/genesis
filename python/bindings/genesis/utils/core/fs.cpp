...
)
{
    ...
    // function-signature: std::string genesis::utils::core::current_path()()
    // file:genesis/utils/core/fs.hpp line:218
    M( "genesis::utils::core" )
        .def(
            "current_path",
            ( std::string( * )() ) & genesis::utils::core::current_path,
            ...
            "process, it is not thread safe.\n\nC++: genesis::utils::core::current_path() --> "
            "std::string"
        );

    // genesis::utils::core::real_path(const std::string &, bool) file:genesis/utils/core/fs.hpp
    // line:228 function-signature: std::string genesis::utils::core::real_path(const std::string &,
    // bool)(const std::string &, bool) file:genesis/utils/core/fs.hpp line:228
    M( "genesis::utils::core" )
        .def(
            "real_path",
            []( const std::string& a0 ) -> std::string {
                return genesis::utils::core::real_path( a0 );
            },
            "",
            pybind11::arg( "path" )
        );
    M( "genesis::utils::core" )
        .def(
            "real_path",
            ( std::string( * )( const std::string&, bool ) ) & genesis::utils::core::real_path,
            ...
            "it is not thread safe.\n\nC++: genesis::utils::core::real_path(const std::string &, "
            "bool) --> std::string",
            pybind11::arg( "path" ),
    ...
    // genesis::utils::core::file_info(const std::string &)(const std::string &)
    // file:genesis/utils/core/fs.hpp line:237
    M( "genesis::utils::core" )
        .def(
            "file_info",
            ( class std::unordered_map<std::string, std::string >( * )( const std::string& ) ) &
                genesis::utils::core::file_info,
            "Return information about a file.\n\nC++: genesis::utils::core::file_info(const "
