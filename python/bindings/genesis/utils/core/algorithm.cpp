...
{
    // genesis::utils::core::stable_sort_indices(class __gnu_cxx::__normal_iterator<const double *,
    // class std::vector<double> >, class __gnu_cxx::__normal_iterator<const double *, class
    // std::vector<double> >, struct std::less<double>) file:genesis/utils/core/algorithm.hpp
    // line:311 function-signature: class std::vector<unsigned long>
    // genesis::utils::core::stable_sort_indices<__gnu_cxx::__normal_iterator<const double *,
    // std::vector<double> >,std::less<double>>(class __gnu_cxx::__normal_iterator<const double *,
    // class std::vector<double> >, class __gnu_cxx::__normal_iterator<const double *, class
    // std::vector<double> >, struct std::less<double>)(class __gnu_cxx::__normal_iterator<const
    // double *, class std::vector<double> >, class __gnu_cxx::__normal_iterator<const double *,
    // class std::vector<double> >, struct std::less<double>) file:genesis/utils/core/algorithm.hpp
    // line:311
    M( "genesis::utils::core" )
        .def(
            "stable_sort_indices",
            ( class std::vector<
                unsigned long>( * )( class __gnu_cxx::__normal_iterator<const double*, class std::vector<double> >, class __gnu_cxx::__normal_iterator<const double*, class std::vector<double> >, struct std::less<double> )
            ) &
                genesis::utils::core::stable_sort_indices<
                    __gnu_cxx::__normal_iterator<const double*, std::vector<double> >,
                    std::less<double>>,
            "C++: genesis::utils::core::stable_sort_indices(class "
            "__gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, class "
            "__gnu_cxx::__normal_iterator<const double *, class std::vector<double> >, struct "
            "std::less<double>) --> class std::vector<unsigned long>",
            pybind11::arg( "first" ),
            pybind11::arg( "last" ),
    ...
    // genesis::utils::core::stable_sort_indices(class __gnu_cxx::__normal_iterator<const double *,
    // class std::vector<double> >, class __gnu_cxx::__normal_iterator<const double *, class
    // std::vector<double> >) file:genesis/utils/core/algorithm.hpp line:353 function-signature:
    ...
    // std::vector<double> >)(class __gnu_cxx::__normal_iterator<const double *, class
    // std::vector<double> >, class __gnu_cxx::__normal_iterator<const double *, class
    // std::vector<double> >) file:genesis/utils/core/algorithm.hpp line:353
    M( "genesis::utils::core" )
        .def(
            "stable_sort_indices",
            ( class std::vector<
    ...
    // genesis::utils::core::file_append(const std::string &, const std::string &, bool)
    // file:genesis/utils/core/fs.hpp line:131 function-signature: void
    // genesis::utils::core::file_append(const std::string &, const std::string &, bool)(const
    // std::string &, const std::string &, bool) file:genesis/utils/core/fs.hpp line:131
    M( "genesis::utils::core" )
        .def(
            "file_append",
            []( const std::string& a0, const std::string& a1 ) -> void {
                return genesis::utils::core::file_append( a0, a1 );
            },
            "",
            pybind11::arg( "content" ),
            pybind11::arg( "filename" )
    ...
    // function-signature: bool genesis::utils::core::is_dir(const std::string &)(const std::string
    // &) file:genesis/utils/core/fs.hpp line:147
    M( "genesis::utils::core" )
        .def(
            "is_dir",
            ( bool ( * )( const std::string& ) ) & genesis::utils::core::is_dir,
            "Return true iff the provided path is a directory.\n\n Internally, this function "
            "simply return the value of dir_exists(), as this already does the\n needed check. "
            "Thus, it is an alias.\n\nC++: genesis::utils::core::is_dir(const std::string &) --> "
            "bool",
            pybind11::arg( "path" )
        );

    // genesis::utils::core::dir_exists(const std::string &) file:genesis/utils/core/fs.hpp line:152
    // function-signature: bool genesis::utils::core::dir_exists(const std::string &)(const
    // std::string &) file:genesis/utils/core/fs.hpp line:152
    M( "genesis::utils::core" )
        .def(
            "dir_exists",
            ( bool ( * )( const std::string& ) ) & genesis::utils::core::dir_exists,
            "Return true iff the directory exists.\n\nC++: genesis::utils::core::dir_exists(const "
            "std::string &) --> bool",
            pybind11::arg( "dir" )
        );

    // genesis::utils::core::dir_create(const std::string &, bool) file:genesis/utils/core/fs.hpp
    // line:161 function-signature: void genesis::utils::core::dir_create(const std::string &,
    // bool)(const std::string &, bool) file:genesis/utils/core/fs.hpp line:161
    M( "genesis::utils::core" )
        .def(
            "dir_create",
            []( const std::string& a0 ) -> void { return genesis::utils::core::dir_create( a0 ); },
            "",
            pybind11::arg( "path" )
        );
    M( "genesis::utils::core" )
        .def(
            "dir_create",
            ( void ( * )( const std::string&, bool ) ) & genesis::utils::core::dir_create,
            ...
            "genesis::utils::core::dir_create(const std::string &, bool) --> void",
            pybind11::arg( "path" ),
            pybind11::arg( "with_parents" )
        );

    // genesis::utils::core::dir_normalize_path(const std::string &) file:genesis/utils/core/fs.hpp
    // line:166 function-signature: std::string genesis::utils::core::dir_normalize_path(const
    // std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:166
    M( "genesis::utils::core" )
        .def(
            "dir_normalize_path",
            ( std::string( * )( const std::string& ) ) & genesis::utils::core::dir_normalize_path,
            "Normalize a dir name, i.e., make sure that the given path ends with exaclty one "
            "slash.\n\nC++: genesis::utils::core::dir_normalize_path(const std::string &) --> "
            "std::string",
            pybind11::arg( "path" )
        );

    // genesis::utils::core::dir_list_contents(const std::string &, bool, const std::string &)
    // file:genesis/utils/core/fs.hpp line:176 function-signature: class std::vector<std::string >
    // genesis::utils::core::dir_list_contents(const std::string &, bool, const std::string &)(const
    // std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:176
    M( "genesis::utils::core" )
        .def(
            "dir_list_contents",
            []( const std::string& a0 ) -> std::vector<std::string > {
                return genesis::utils::core::dir_list_contents( a0 );
            },
            "",
            pybind11::arg( "dir" )
        );
    M( "genesis::utils::core" )
        .def(
            ...
            []( const std::string& a0, bool const& a1 ) -> std::vector<std::string > {
                return genesis::utils::core::dir_list_contents( a0, a1 );
            },
            "",
            pybind11::arg( "dir" ),
    ...
    M( "genesis::utils::core" )
        .def(
            ...
            ) & genesis::utils::core::dir_list_contents,
    ...
    // genesis::utils::core::dir_list_files(const std::string &, bool, const std::string &)
    // file:genesis/utils/core/fs.hpp line:188 function-signature: class std::vector<std::string >
    // genesis::utils::core::dir_list_files(const std::string &, bool, const std::string &)(const
    // std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:188
    M( "genesis::utils::core" )
        .def(
            "dir_list_files",
            []( const std::string& a0 ) -> std::vector<std::string > {
                return genesis::utils::core::dir_list_files( a0 );
            },
            "",
            pybind11::arg( "dir" )
        );
    M( "genesis::utils::core" )
        .def(
            "dir_list_files",
            []( const std::string& a0, bool const& a1 ) -> std::vector<std::string > {
                return genesis::utils::core::dir_list_files( a0, a1 );
            },
            "",
            pybind11::arg( "dir" ),
            pybind11::arg( "full_path" )
    ...
    // genesis::utils::core::dir_list_directories(const std::string &, bool, const std::string &)
    // file:genesis/utils/core/fs.hpp line:200 function-signature: class std::vector<std::string >
    // genesis::utils::core::dir_list_directories(const std::string &, bool, const std::string
    // &)(const std::string &, bool, const std::string &) file:genesis/utils/core/fs.hpp line:200
    M( "genesis::utils::core" )
        .def(
            "dir_list_directories",
            []( const std::string& a0 ) -> std::vector<std::string > {
                return genesis::utils::core::dir_list_directories( a0 );
            },
            "",
            pybind11::arg( "dir" )
        );
    M( "genesis::utils::core" )
        .def(
            "dir_list_directories",
            []( const std::string& a0, bool const& a1 ) -> std::vector<std::string > {
                return genesis::utils::core::dir_list_directories( a0, a1 );
            },
            "",
            pybind11::arg( "dir" ),
            pybind11::arg( "full_path" )
    ...
    M( "genesis::utils::core" )
        .def(
            "dir_list_directories",
            ( class std::vector<std::string >( * )( const std::string&, bool, const std::string& )
            ) & genesis::utils::core::dir_list_directories,
            ...
            "genesis::utils::core::dir_list_directories(const std::string &, bool, const "
