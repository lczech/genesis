...
)
{
    { // genesis::utils::core::Options file:genesis/utils/core/options.hpp line:58
        pybind11::class_<genesis::utils::core::Options, genesis::utils::core::Options*> cl(
            M( "genesis::utils::core" ),
            "Options",
            "Simple Options class for application-wide configuration and settings."
        );

        pybind11::enum_<genesis::utils::core::Options::InputReadingThreadPolicy>(
            ...
            .value(
                "kTrivialAsync",
                genesis::utils::core::Options::InputReadingThreadPolicy::kTrivialAsync
            )
            .value(
                "kAllAsync", genesis::utils::core::Options::InputReadingThreadPolicy::kAllAsync
            );

        // function-signature: class genesis::utils::core::Options &
        // genesis::utils::core::Options::get()() file:genesis/utils/core/options.hpp line:69
        cl.def_static(
            "get",
            ( class genesis::utils::core::Options & (*)() ) & genesis::utils::core::Options::get,
            "Returns a single instance of this class.\n\nC++: genesis::utils::core::Options::get() "
            "--> class genesis::utils::core::Options &",
            pybind11::return_value_policy::reference
        );
        // function-signature: unsigned long genesis::utils::core::Options::random_seed() const()
        // file:genesis/utils/core/options.hpp line:125
        cl.def(
            "random_seed",
            ( unsigned long ( genesis::utils::core::Options::* )() const ) &
                genesis::utils::core::Options::random_seed,
            ...
            "genesis::utils::core::Options::random_seed() const --> unsigned long"
        );
        // function-signature: void genesis::utils::core::Options::random_seed(const unsigned
        // long)(const unsigned long) file:genesis/utils/core/options.hpp line:148
        cl.def(
            "random_seed",
            ( void( genesis::utils::core::Options::* )( const unsigned long ) ) &
                genesis::utils::core::Options::random_seed,
            ...
            "random engine.\n\nC++: genesis::utils::core::Options::random_seed(const unsigned "
            "long) --> void",
            pybind11::arg( "seed" )
        );
        // function-signature: unsigned long genesis::utils::core::Options::seed_counter() const()
        // file:genesis/utils/core/options.hpp line:179
        cl.def(
            "seed_counter",
            ( unsigned long ( genesis::utils::core::Options::* )() const ) &
                genesis::utils::core::Options::seed_counter,
            ...
            "genesis::utils::core::Options::seed_counter() const --> unsigned long"
        );
        // function-signature: void genesis::utils::core::Options::init_global_thread_pool()()
        // file:genesis/utils/core/options.hpp line:218
        cl.def(
            "init_global_thread_pool",
            ( void( genesis::utils::core::Options::* )() ) &
                genesis::utils::core::Options::init_global_thread_pool,
            ...
            "genesis::utils::core::Options::init_global_thread_pool() --> void"
        );
        // function-signature: void genesis::utils::core::Options::init_global_thread_pool(unsigned
        // long, unsigned long)(unsigned long, unsigned long) file:genesis/utils/core/options.hpp
        // line:245
        cl.def(
            "init_global_thread_pool",
            []( genesis::utils::core::Options& o, unsigned long const& a0 ) -> void {
        ...
        cl.def(
            "init_global_thread_pool",
            ( void( genesis::utils::core::Options::* )( unsigned long, unsigned long ) ) &
                genesis::utils::core::Options::init_global_thread_pool,
            "Initialize the global thread pool to be used for parallel computations.\n\n This "
            ...
            "work.\n\nC++: genesis::utils::core::Options::init_global_thread_pool(unsigned long, "
            "unsigned long) --> void",
            pybind11::arg( "num_threads" ),
            pybind11::arg( "max_queue_size" )
        );
        // function-signature: bool genesis::utils::core::Options::has_global_thread_pool() const()
        // file:genesis/utils/core/options.hpp line:289
        cl.def(
            "has_global_thread_pool",
            ( bool( genesis::utils::core::Options::* )() const ) &
                genesis::utils::core::Options::has_global_thread_pool,
            "Return if a global thread pool has been initialized, i.e., if "
            "init_global_thread_pool()\n has already been called.\n\nC++: "
            "genesis::utils::core::Options::has_global_thread_pool() const --> bool"
        );
        // function-signature: unsigned long
        // genesis::utils::core::Options::global_thread_pool_size() const()
        // file:genesis/utils/core/options.hpp line:299
        cl.def(
            "global_thread_pool_size",
            ( unsigned long ( genesis::utils::core::Options::* )() const ) &
                genesis::utils::core::Options::global_thread_pool_size,
            ...
            "well.\n\nC++: genesis::utils::core::Options::global_thread_pool_size() const --> "
            "unsigned long"
        );
        // function-signature: void genesis::utils::core::Options::input_reading_thread_policy(enum
        // genesis::utils::core::Options::InputReadingThreadPolicy)(enum
        // genesis::utils::core::Options::InputReadingThreadPolicy)
        // file:genesis/utils/core/options.hpp line:352
        cl.def(
            "input_reading_thread_policy",
            ( void( genesis::utils::core::Options::* )(
                enum genesis::utils::core::Options::InputReadingThreadPolicy
            ) ) &
                genesis::utils::core::Options::input_reading_thread_policy,
            "Set the policy for the threading of input source reading.\n\nC++: "
            "genesis::utils::core::Options::input_reading_thread_policy(enum "
            "genesis::utils::core::Options::InputReadingThreadPolicy) --> void",
            pybind11::arg( "policy" )
        );
        // function-signature: enum genesis::utils::core::Options::InputReadingThreadPolicy
        // genesis::utils::core::Options::input_reading_thread_policy()()
        // file:genesis/utils/core/options.hpp line:360
        cl.def(
            "input_reading_thread_policy",
            ( enum genesis::utils::core::Options::
                  InputReadingThreadPolicy( genesis::utils::core::Options::* )() ) &
                genesis::utils::core::Options::input_reading_thread_policy,
            "Get the policy for the threading of input source reading.\n\nC++: "
            "genesis::utils::core::Options::input_reading_thread_policy() --> enum "
            "genesis::utils::core::Options::InputReadingThreadPolicy"
        );
        // function-signature: bool genesis::utils::core::Options::allow_file_overwriting() const()
        // file:genesis/utils/core/options.hpp line:374
        cl.def(
            "allow_file_overwriting",
            ( bool( genesis::utils::core::Options::* )() const ) &
                genesis::utils::core::Options::allow_file_overwriting,
            "Get whether Genesis is allowed to overwrite files when outputting data.\n\n See "
            "allow_file_overwriting( bool ) for details.\n\nC++: "
            "genesis::utils::core::Options::allow_file_overwriting() const --> bool"
        );
        // function-signature: void
        // genesis::utils::core::Options::allow_file_overwriting(bool)(bool)
        // file:genesis/utils/core/options.hpp line:392
        cl.def(
            "allow_file_overwriting",
            ( void( genesis::utils::core::Options::* )( bool ) ) &
                genesis::utils::core::Options::allow_file_overwriting,
            ...
            "genesis::utils::core::Options::allow_file_overwriting(bool) --> void",
            pybind11::arg( "value" )
        );
    }
}
