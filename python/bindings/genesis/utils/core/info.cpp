...
)
{
    { // genesis::utils::core::InfoCompiler file:genesis/utils/core/info.hpp line:49
        pybind11::class_<
            ...
            std::shared_ptr<genesis::utils::core::InfoCompiler>>
            cl( M( "genesis::utils::core" ), "InfoCompiler", "" );
        // function-signature: genesis::utils::core::InfoCompiler()
        cl.def( pybind11::init( []() { return new genesis::utils::core::InfoCompiler(); } ) );
        // function-signature: genesis::utils::core::InfoCompiler::InfoCompiler(const struct
        // genesis::utils::core::InfoCompiler &)(const struct genesis::utils::core::InfoCompiler &)
        // file:genesis/utils/core/info.hpp line:49
        cl.def( pybind11::init( []( genesis::utils::core::InfoCompiler const& o ) {
            return new genesis::utils::core::InfoCompiler( o );
        } ) );
        cl.def_readwrite(
            "compile_date_time", &genesis::utils::core::InfoCompiler::compile_date_time
        );
        ...
        cl.def_readwrite(
            "compiler_version", &genesis::utils::core::InfoCompiler::compiler_version
        );
        ...
        // function-signature: struct genesis::utils::core::InfoCompiler &
        // genesis::utils::core::InfoCompiler::operator=(const struct
        // genesis::utils::core::InfoCompiler &)(const struct genesis::utils::core::InfoCompiler &)
        // file:genesis/utils/core/info.hpp line:49
        cl.def(
            "assign",
            ( struct genesis::utils::core::InfoCompiler &
              (genesis::utils::core::InfoCompiler::*)(const struct genesis::utils::core::
                                                          InfoCompiler&)) &
    ...
    // function-signature: const struct genesis::utils::core::InfoCompiler &
    // genesis::utils::core::info_get_compiler()() file:genesis/utils/core/info.hpp line:134
    M( "genesis::utils::core" )
        .def(
            "info_get_compiler",
            ( const struct genesis::utils::core::InfoCompiler& (*)() ) &
                genesis::utils::core::info_get_compiler,
    ...
    // line:142 function-signature: const class std::unordered_map<std::string, std::string > &
    // genesis::utils::core::info_preprocessor_definitions()() file:genesis/utils/core/info.hpp
    // line:142
    M( "genesis::utils::core" )
        .def(
            ...
            ( const class std::unordered_map<std::string, std::string >& (*)() ) &
                genesis::utils::core::info_preprocessor_definitions,
    ...
    // function-signature: std::string genesis::utils::core::info_print_compiler()()
    // file:genesis/utils/core/info.hpp line:147
    M( "genesis::utils::core" )
        .def(
            "info_print_compiler",
            ( std::string( * )() ) & genesis::utils::core::info_print_compiler,
            "Print information about compiler settings and flags to a string.\n\nC++: "
            "genesis::utils::core::info_print_compiler() --> std::string"
        );

    { // genesis::utils::core::InfoHardware file:genesis/utils/core/info.hpp line:153
        pybind11::class_<
            genesis::utils::core::InfoHardware,
            std::shared_ptr<genesis::utils::core::InfoHardware>>
            cl( M( "genesis::utils::core" ), "InfoHardware", "" );
        // function-signature: genesis::utils::core::InfoHardware()
        cl.def( pybind11::init( []() { return new genesis::utils::core::InfoHardware(); } ) );
        // function-signature: genesis::utils::core::InfoHardware::InfoHardware(const struct
        // genesis::utils::core::InfoHardware &)(const struct genesis::utils::core::InfoHardware &)
        // file:genesis/utils/core/info.hpp line:153
        cl.def( pybind11::init( []( genesis::utils::core::InfoHardware const& o ) {
            return new genesis::utils::core::InfoHardware( o );
        } ) );
        cl.def_readwrite(
            "is_little_endian", &genesis::utils::core::InfoHardware::is_little_endian
        );
        ...
        cl.def_readwrite(
            "physical_core_count", &genesis::utils::core::InfoHardware::physical_core_count
        );
        cl.def_readwrite(
            "with_hyperthreading", &genesis::utils::core::InfoHardware::with_hyperthreading
        );
        ...
        cl.def_readwrite(
            "HW_AVX512_VPOPCNTDQ", &genesis::utils::core::InfoHardware::HW_AVX512_VPOPCNTDQ
        );
        cl.def_readwrite(
            "HW_AVX512_4VNNIW", &genesis::utils::core::InfoHardware::HW_AVX512_4VNNIW
        );
        cl.def_readwrite(
            "HW_AVX512_4FMAPS", &genesis::utils::core::InfoHardware::HW_AVX512_4FMAPS
        );
        ...
        cl.def_readwrite(
            "HW_AVX512_VPCLMUL", &genesis::utils::core::InfoHardware::HW_AVX512_VPCLMUL
        );
        cl.def_readwrite(
            "HW_AVX512_BITALG", &genesis::utils::core::InfoHardware::HW_AVX512_BITALG
        );
        // function-signature: struct genesis::utils::core::InfoHardware &
        // genesis::utils::core::InfoHardware::operator=(const struct
        // genesis::utils::core::InfoHardware &)(const struct genesis::utils::core::InfoHardware &)
        // file:genesis/utils/core/info.hpp line:153
        cl.def(
            "assign",
            ( struct genesis::utils::core::InfoHardware &
              (genesis::utils::core::InfoHardware::*)(const struct genesis::utils::core::
                                                          InfoHardware&)) &
    ...
    // function-signature: const struct genesis::utils::core::InfoHardware &
    // genesis::utils::core::info_get_hardware()() file:genesis/utils/core/info.hpp line:250
    M( "genesis::utils::core" )
        .def(
            "info_get_hardware",
            ( const struct genesis::utils::core::InfoHardware& (*)() ) &
                genesis::utils::core::info_get_hardware,
    ...
    // function-signature: std::string genesis::utils::core::info_print_hardware(bool)(bool)
    // file:genesis/utils/core/info.hpp line:259
    M( "genesis::utils::core" )
        .def(
            "info_print_hardware",
            []() -> std::string { return genesis::utils::core::info_print_hardware(); },
            ""
        );
    M( "genesis::utils::core" )
        .def(
            "info_print_hardware",
            ( std::string( * )( bool ) ) & genesis::utils::core::info_print_hardware,
            ...
            "genesis::utils::core::info_print_hardware(bool) --> std::string",
            pybind11::arg( "full" )
        );

    // genesis::utils::core::info_use_avx() file:genesis/utils/core/info.hpp line:267
    // function-signature: bool genesis::utils::core::info_use_avx()()
    // file:genesis/utils/core/info.hpp line:267
    M( "genesis::utils::core" )
        .def(
            "info_use_avx",
            ( bool ( * )() ) & genesis::utils::core::info_use_avx,
    ...
    // function-signature: bool genesis::utils::core::info_use_avx2()()
    // file:genesis/utils/core/info.hpp line:275
    M( "genesis::utils::core" )
        .def(
            "info_use_avx2",
            ( bool ( * )() ) & genesis::utils::core::info_use_avx2,
    ...
    // function-signature: bool genesis::utils::core::info_use_avx512()()
    // file:genesis/utils/core/info.hpp line:283
    M( "genesis::utils::core" )
        .def(
            "info_use_avx512",
            ( bool ( * )() ) & genesis::utils::core::info_use_avx512,
    ...
    // function-signature: unsigned long genesis::utils::core::info_physical_core_count()()
    // file:genesis/utils/core/info.hpp line:296
    M( "genesis::utils::core" )
        .def(
            "info_physical_core_count",
            ( unsigned long ( * )() ) & genesis::utils::core::info_physical_core_count,
    ...
    // function-signature: bool genesis::utils::core::info_hyperthreads_enabled()()
    // file:genesis/utils/core/info.hpp line:301
    M( "genesis::utils::core" )
        .def(
            "info_hyperthreads_enabled",
            ( bool ( * )() ) & genesis::utils::core::info_hyperthreads_enabled,
            "Try to get whether hyperthreads are enabled in the current system.\n\nC++: "
            "genesis::utils::core::info_hyperthreads_enabled() --> bool"
        );

    // genesis::utils::core::info_number_of_threads_openmp() file:genesis/utils/core/info.hpp
    // line:313 function-signature: unsigned long
    // genesis::utils::core::info_number_of_threads_openmp()() file:genesis/utils/core/info.hpp
    // line:313
    M( "genesis::utils::core" )
        .def(
            "info_number_of_threads_openmp",
            ( unsigned long ( * )() ) & genesis::utils::core::info_number_of_threads_openmp,
            ...
            "genesis::utils::core::info_number_of_threads_openmp() --> unsigned long"
        );

    // genesis::utils::core::info_number_of_threads_slurm() file:genesis/utils/core/info.hpp
    // line:320 function-signature: unsigned long
    // genesis::utils::core::info_number_of_threads_slurm()() file:genesis/utils/core/info.hpp
    // line:320
    M( "genesis::utils::core" )
        .def(
            "info_number_of_threads_slurm",
            ( unsigned long ( * )() ) & genesis::utils::core::info_number_of_threads_slurm,
            ...
            "genesis::utils::core::info_number_of_threads_slurm() --> unsigned long"
        );

    // genesis::utils::core::guess_number_of_threads(bool, bool, bool)
    // file:genesis/utils/core/info.hpp line:348 function-signature: unsigned long
    // genesis::utils::core::guess_number_of_threads(bool, bool, bool)(bool, bool, bool)
    // file:genesis/utils/core/info.hpp line:348
    M( "genesis::utils::core" )
        .def(
            "guess_number_of_threads",
            []() -> unsigned long { return genesis::utils::core::guess_number_of_threads(); },
            ""
        );
    M( "genesis::utils::core" )
        .def(
            ...
            []( bool const& a0 ) -> unsigned long {
                return genesis::utils::core::guess_number_of_threads( a0 );
            },
            "",
    ...
    M( "genesis::utils::core" )
        .def(
            ...
            []( bool const& a0, bool const& a1 ) -> unsigned long {
                return genesis::utils::core::guess_number_of_threads( a0, a1 );
            },
            "",
            pybind11::arg( "use_openmp" ),
    ...
    M( "genesis::utils::core" )
        .def(
            ...
            ( unsigned long ( * )( bool, bool, bool ) ) &
                genesis::utils::core::guess_number_of_threads,
            ...
            "genesis::utils::core::guess_number_of_threads(bool, bool, bool) --> unsigned long",
            pybind11::arg( "use_openmp" ),
            pybind11::arg( "use_slurm" ),
