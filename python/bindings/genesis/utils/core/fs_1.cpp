...
void bind_genesis_utils_core_fs_1(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// function-signature: std::string genesis::utils::file_path(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:249
	...
	// function-signature: std::string genesis::utils::file_basename(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:254
	...
	// genesis::utils::file_basename(const std::string &, const class std::vector<std::string > &) file:genesis/utils/core/fs.hpp line:273
	// function-signature: std::string genesis::utils::file_basename(const std::string &, const class std::vector<std::string > &)(const std::string &, const class std::vector<std::string > &) file:genesis/utils/core/fs.hpp line:273
	M("genesis::utils").def("file_basename", (std::string (*)(const std::string &, const class std::vector<std::string > &)) &genesis::utils::file_basename, "Remove the directory name from a file name if present, and remove a list of given extensions.\n\n After obtaining the file basename (the final rightmost segment of the file path after the last\n directory seperator `/`), the  are also removed from the file name.\n The given list is iterated regularly, and removed (from right to left, as these are suffixes)\n from the file name, if present.\n\n For example:\n\n     std::string path = \"/path/to/filename.txt.gz\";\n     std::cout << file_basename( path, { \".gz\", \".txt\" }) << \"\\n\";\n\n yields \"filename\". This is useful for example to remove a set of known extensions for a file\n type, for clean user output. Not all extensions have to be present; those that are not, are\n simply skipped.\n\nC++: genesis::utils::file_basename(const std::string &, const class std::vector<std::string > &) --> std::string", pybind11::arg("filename"), pybind11::arg("remove_extensions"));

	// genesis::utils::file_filename(const std::string &) file:genesis/utils/core/fs.hpp line:284
	// function-signature: std::string genesis::utils::file_filename(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:284
	...
	// function-signature: std::string genesis::utils::file_extension(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:291
	...
	// function-signature: bool genesis::utils::is_valid_filename(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:317
	...
	// function-signature: std::string genesis::utils::sanitize_filename(const std::string &)(const std::string &) file:genesis/utils/core/fs.hpp line:340
