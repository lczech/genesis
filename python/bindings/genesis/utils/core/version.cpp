...
)
{
    ...
    // file:genesis/utils/core/version.hpp line:63
    M( "genesis" )
        .def(
            "genesis_version",
    ...
    // file:genesis/utils/core/version.hpp line:74
    M( "genesis" )
        .def(
    ...
    // function-signature: std::string genesis::genesis_url()() file:genesis/utils/core/version.hpp
    // line:83
    M( "genesis" )
        .def(
            "genesis_url",
    ...
    // file:genesis/utils/core/version.hpp line:94
    M( "genesis" )
        .def(
            "genesis_header",
    ...
    // file:genesis/utils/core/version.hpp line:114
    M( "genesis" )
        .def(
            "genesis_license",
    ...
    // function-signature: std::string genesis::ee(int)(int) file:genesis/utils/core/version.hpp
    // line:139
    M( "genesis" )
        .def(
            "ee",
