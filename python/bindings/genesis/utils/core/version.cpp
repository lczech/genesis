...
void bind_genesis_utils_core_version(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	// function-signature: std::string genesis::genesis_version()() file:genesis/utils/core/version.hpp line:63
	...
	// function-signature: std::string genesis::genesis_version_name()() file:genesis/utils/core/version.hpp line:74
	...
	// function-signature: std::string genesis::genesis_url()() file:genesis/utils/core/version.hpp line:83
	...
	// function-signature: std::string genesis::genesis_header()() file:genesis/utils/core/version.hpp line:94
	...
	// function-signature: std::string genesis::genesis_license()() file:genesis/utils/core/version.hpp line:114
	...
	// function-signature: std::string genesis::ee(int)(int) file:genesis/utils/core/version.hpp line:139
