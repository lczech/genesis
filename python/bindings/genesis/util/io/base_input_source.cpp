...
#include <genesis/util/io/base_input_source_add_ons.hpp>
...
)
{
    ...
    genesis_util_io_input_source_add_ons( M( "genesis::util::io" ) );

    genesis_util_io_output_target_add_ons( M( "genesis::util::io" ) );
    { // genesis::util::io::BaseInputSource file:genesis/util/io/base_input_source.hpp line:51
        pybind11::class_<
            genesis::util::io::BaseInputSource,
            std::shared_ptr<genesis::util::io::BaseInputSource>>
        ...
        // function-signature: std::string genesis::util::io::BaseInputSource::source_name() const()
        // file:genesis/util/io/base_input_source.hpp line:89
        cl.def(
            "source_name",
            ( std::string( genesis::util::io::BaseInputSource::* )() const ) &
                genesis::util::io::BaseInputSource::source_name,
            "Get a name of the input source. This is intended for user output.\n\nC++: "
            "genesis::util::io::BaseInputSource::source_name() const --> std::string"
        );
        // function-signature: std::string genesis::util::io::BaseInputSource::source_string()
        // const() file:genesis/util/io/base_input_source.hpp line:99
        cl.def(
            "source_string",
            ( std::string( genesis::util::io::BaseInputSource::* )() const ) &
                genesis::util::io::BaseInputSource::source_string,
            ...
            "genesis::util::io::BaseInputSource::source_string() const --> std::string"
        );
        // function-signature: bool genesis::util::io::BaseInputSource::is_trivial() const()
        // file:genesis/util/io/base_input_source.hpp line:117
        cl.def(
            "is_trivial",
            ( bool( genesis::util::io::BaseInputSource::* )() const ) &
                genesis::util::io::BaseInputSource::is_trivial,
            ...
            "trivial.\n\nC++: genesis::util::io::BaseInputSource::is_trivial() const --> bool"
        );

        genesis_util_io_base_input_source_add_ons( cl );
    }
}
