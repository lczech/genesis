...
class TestGenesisutilHash(unittest.TestCase):
    def test_md5(self):
        hash = util.MD5.read_hex(
            util.io.from_string( "abc" )
        )
    ...
    def test_hash_hex_md5(self):
        hash = util.hash_hex(
            util.io.from_string( "abc" ),
            util.HashingFunctions.kMD5
        )
        self.assertEqual( hash, "900150983cd24fb0d6963f7d28e17f72" )

    def test_sha1(self):
        hash = util.SHA1.read_hex(
            util.io.from_string( "abc" )
        )
    ...
    def test_hash_hex_sha1(self):
        hash = util.hash_hex(
            util.io.from_string( "abc" ),
            util.HashingFunctions.kSHA1
        )
        self.assertEqual( hash, "a9993e364706816aba3e25717850c26c9cd0d89d" )

    def test_sha256(self):
        hash = util.SHA256.read_hex(
            util.io.from_string( "abc" )
        )
