...
class TestGenesisUtilsMathCorrelation(unittest.TestCase):
    def test_spearmans_rank_correlation_coeffcient(self):
        ...
        self.assertEqual( c, -0.17575757575757575 )
    ...
    def test_kendalls_tau_correlation_coeffcient(self):
        ...
        self.assertEqual( ca, 0.466666666666666666 )
        self.assertEqual( cb, 0.466666666666666666 )
        self.assertEqual( cc, 0.466666666666666666 )
