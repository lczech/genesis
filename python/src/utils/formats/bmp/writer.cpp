...
PYTHON_EXPORT_CLASS( ::genesis::utils::BmpWriter, scope )
{
    ...
    pybind11::class_< ::genesis::utils::BmpWriter, std::shared_ptr<::genesis::utils::BmpWriter> > ( scope, "BmpWriter" )
        ...
        .def(
            "to_file",
            ( void ( ::genesis::utils::BmpWriter::* )( Matrix< unsigned char > const &, std::vector< Color > const &, std::string const & ) const )( &::genesis::utils::BmpWriter::to_file ),
            pybind11::arg("image"),
            pybind11::arg("palette"),
            pybind11::arg("filename"),
            get_docstring("void ::genesis::utils::BmpWriter::to_file (Matrix< unsigned char > const & image, std::vector< Color > const & palette, std::string const & filename) const")
        )
        .def(
            "to_stream",
        ...
        .def(
            "to_stream",
            ( void ( ::genesis::utils::BmpWriter::* )( Matrix< unsigned char > const &, std::vector< Color > const &, std::ostream & ) const )( &::genesis::utils::BmpWriter::to_stream ),
            pybind11::arg("image"),
            pybind11::arg("palette"),
            pybind11::arg("outstream"),
            get_docstring("void ::genesis::utils::BmpWriter::to_stream (Matrix< unsigned char > const & image, std::vector< Color > const & palette, std::ostream & outstream) const")
        )
    ;
}
