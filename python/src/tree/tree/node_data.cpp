...
PYTHON_EXPORT_CLASS( ::genesis::tree::BaseNodeData, scope )
{
    ...
    pybind11::class_< ::genesis::tree::BaseNodeData, std::shared_ptr<::genesis::tree::BaseNodeData> > ( scope, "BaseNodeData" )
        ...
        .def_static(
            ...
            get_docstring("static std::unique_ptr< BaseNodeData > ::genesis::tree::BaseNodeData::create ()")
        )
    ;
}
