...
TEST( Matrix, Standardize )
{
    ...
    NEEDS_TEST_DATA;
    auto data    = read_stats_csv_data( "util/matrix/iris.data.csv", 150, 4 );
    auto stddata = read_stats_csv_data( "util/matrix/iris.standardized.csv", 150, 4 );
...
TEST( Matrix, StandardizeMeans )
{
    ...
    NEEDS_TEST_DATA;
    auto data    = read_stats_csv_data( "util/matrix/iris.data.csv", 150, 4 );
    auto stddata = read_stats_csv_data( "util/matrix/iris.standardized_means.csv", 150, 4 );
...
TEST( Matrix, StandardizeStddevs )
{
    ...
    NEEDS_TEST_DATA;
    auto data    = read_stats_csv_data( "util/matrix/iris.data.csv", 150, 4 );
    auto stddata = read_stats_csv_data( "util/matrix/iris.standardized_stddevs.csv", 150, 4 );
