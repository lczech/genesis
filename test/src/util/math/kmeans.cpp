...
TEST( Math, Kmeans )
{
    ...
    // genesis::util::core::Options::get().number_of_threads( 4 );
    // genesis::util::core::Options::get().random_seed( 174333141 );
    ...
    kmeans.initialization_strategy( KmeansInitializationStrategy::kKmeansPlusPlus );
    kmeans.run( data, 3 );
