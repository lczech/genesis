...
TEST( Container, MruCacheLimitless )
{
...
TEST( Container, MruCacheFailLoading )
{
...
TEST( Container, MruCacheFiles )
{
    ...
    // Path to our data.
    std::string dir = environment->data_dir + "util/json";
...
TEST( Container, MruCacheSharedPtr )
{
...
TEST( Container, MruCacheThreading )
{
    NEEDS_TEST_DATA;
