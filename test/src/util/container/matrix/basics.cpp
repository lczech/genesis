...
{
    // Activate logging.
    genesis::util::Logging::log_to_stdout();
    genesis::util::Logging::log_to_file( "triangular.log" );
    genesis::util::Logging::details.time = true;

    size_t const num_threads = 4;

    genesis::util::core::Options::get().command_line( argc, argv );
    genesis::util::core::Options::get().number_of_threads( num_threads );
    LOG_BOLD << genesis::util::core::Options::get().info();
    LOG_BOLD;
...
int main( int argc, char** argv )
{
    // Activate logging.
    genesis::util::Logging::log_to_stdout();
    genesis::util::Logging::log_to_file( "triangular2.log" );
    genesis::util::Logging::details.time = true;
