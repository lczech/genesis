...
TEST( Container, DataframeMatrix )
{
    NEEDS_TEST_DATA;

    auto const infile = environment->data_dir + "util/matrix/headers.mat";
...
TEST( Container, DataframeCsv )
{
    NEEDS_TEST_DATA;
    auto const infile = environment->data_dir + "util/csv/table.csv";
...
TEST( Container, DataframeReplaceCol )
{
    // Get data as before.
    NEEDS_TEST_DATA;
    auto const infile = environment->data_dir + "util/csv/table.csv";
...
TEST( Container, DataframeConvertString )
{
    // Read stuff.
    NEEDS_TEST_DATA;
    auto const infile = environment->data_dir + "util/csv/table.csv";
...
TEST( Container, DataframeAddReplaceCols )
{
    // Read stuff.
    NEEDS_TEST_DATA;
    auto const infile = environment->data_dir + "util/csv/table.csv";
