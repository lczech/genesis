...
TEST( Container, TransformIteratorCopy )
{
...
TEST( Container, TransformIteratorConstReference )
{
...
TEST( Container, TransformIteratorReference )
{
    // Prepare a list of consequtive numbers, in a pair, where only one entry is useful for us here.
    size_t size = 10;
    std::vector<std::pair<size_t, size_t>> list;
...
TEST( Container, GenericInputStream )
{
