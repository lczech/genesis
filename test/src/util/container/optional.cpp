...
// See our Optional implementation in genesis/lib/genesis/util/containers/optional.hpp
...
TEST( Container, OptionalConstruction )
{
...
TEST( Container, OptionalAssignment )
{
...
TEST( Container, OptionalSwapModify )
{
...
TEST( Container, OptionalObservers )
{
    {
...
TEST( Container, OptionalNonMemberFunctions )
{
