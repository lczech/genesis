...
TEST( Pileup, SimpleReader )
{
    ...
    EXPECT_EQ(  0, records[0].samples[0].A );
    EXPECT_EQ(  0, records[0].samples[0].C );
    EXPECT_EQ(  0, records[0].samples[0].G );
    EXPECT_EQ( 24, records[0].samples[0].T );
    EXPECT_EQ(  0, records[0].samples[0].N );
    EXPECT_EQ(  0, records[0].samples[0].del );
    EXPECT_EQ( 24, records[0].samples[0].read_count );
    EXPECT_EQ( 24, records[0].samples[0].nucleotide_count );

    EXPECT_EQ(  1, records[1].samples[0].A );
    EXPECT_EQ(  0, records[1].samples[0].C );
    EXPECT_EQ(  0, records[1].samples[0].G );
    EXPECT_EQ( 20, records[1].samples[0].T );
    EXPECT_EQ(  2, records[1].samples[0].N );
    EXPECT_EQ(  0, records[1].samples[0].del );
    EXPECT_EQ( 23, records[1].samples[0].read_count );
    EXPECT_EQ( 21, records[1].samples[0].nucleotide_count );

    EXPECT_EQ(  0, records[2].samples[0].A );
    EXPECT_EQ(  0, records[2].samples[0].C );
    EXPECT_EQ(  0, records[2].samples[0].G );
    EXPECT_EQ( 21, records[2].samples[0].T );
    EXPECT_EQ(  0, records[2].samples[0].N );
    EXPECT_EQ(  2, records[2].samples[0].del );
    EXPECT_EQ( 23, records[2].samples[0].read_count );
    EXPECT_EQ( 21, records[2].samples[0].nucleotide_count );

    EXPECT_EQ( 23, records[3].samples[0].A );
    EXPECT_EQ(  0, records[3].samples[0].C );
    EXPECT_EQ(  0, records[3].samples[0].G );
    EXPECT_EQ(  0, records[3].samples[0].T );
    EXPECT_EQ(  0, records[3].samples[0].N );
    EXPECT_EQ(  0, records[3].samples[0].del );
    EXPECT_EQ( 23, records[3].samples[0].read_count );
    EXPECT_EQ( 23, records[3].samples[0].nucleotide_count );

    EXPECT_EQ(  0, records[4].samples[0].A );
    EXPECT_EQ(  0, records[4].samples[0].C );
    EXPECT_EQ( 21, records[4].samples[0].G );
    EXPECT_EQ(  1, records[4].samples[0].T );
    EXPECT_EQ(  0, records[4].samples[0].N );
    EXPECT_EQ(  0, records[4].samples[0].del );
    EXPECT_EQ( 22, records[4].samples[0].read_count );
    EXPECT_EQ( 22, records[4].samples[0].nucleotide_count );

    EXPECT_EQ(  0, records[5].samples[0].A );
    EXPECT_EQ(  1, records[5].samples[0].C );
    EXPECT_EQ(  1, records[5].samples[0].G );
    EXPECT_EQ( 20, records[5].samples[0].T );
    EXPECT_EQ(  0, records[5].samples[0].N );
    EXPECT_EQ(  0, records[5].samples[0].del );
    EXPECT_EQ( 22, records[5].samples[0].read_count );
    EXPECT_EQ( 22, records[5].samples[0].nucleotide_count );

    EXPECT_EQ(  0, records[6].samples[0].A );
    EXPECT_EQ(  0, records[6].samples[0].C );
    EXPECT_EQ( 23, records[6].samples[0].G );
    EXPECT_EQ(  0, records[6].samples[0].T );
    EXPECT_EQ(  0, records[6].samples[0].N );
    EXPECT_EQ(  0, records[6].samples[0].del );
    EXPECT_EQ( 23, records[6].samples[0].read_count );
    EXPECT_EQ( 23, records[6].samples[0].nucleotide_count );

    EXPECT_EQ(  1, records[7].samples[0].A );
    EXPECT_EQ( 17, records[7].samples[0].C );
    EXPECT_EQ(  0, records[7].samples[0].G );
    EXPECT_EQ(  1, records[7].samples[0].T );
    EXPECT_EQ(  0, records[7].samples[0].N );
    EXPECT_EQ(  0, records[7].samples[0].del );
    EXPECT_EQ( 23, records[7].samples[0].read_count );
