...
// static const size_t SHA1::BlockInts = 16;  /* number of 32bit integers per SHA1 block */
// static const size_t SHA1::BlockBytes = SHA1::BlockInts * 4;
...
static uint32_t blk(const uint32_t block[SHA1::BlockInts], const size_t i)
{
 ...
 */
static void transform(uint32_t digest[], uint32_t block[SHA1::BlockInts], uint64_t& transforms)
{
 ...
 */
static void buffer_to_block(const std::string& buffer, uint32_t block[SHA1::BlockInts])
{
