...
genesis::util::container::Matrix<double> node_branch_length_distance_matrix(
    ...
    genesis::util::container::Matrix<double> result( tree.node_count(), tree.node_count(), 0.0 );
...
genesis::util::container::Matrix<double> edge_branch_length_distance_matrix(
    ...
    genesis::util::container::Matrix<double> mat (tree.edge_count(), tree.edge_count());
