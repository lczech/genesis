#ifndef GENESIS_POPULATION_STREAM_VARIANT_PARALLEL_INPUT_STREAM_H_
#define GENESIS_POPULATION_STREAM_VARIANT_PARALLEL_INPUT_STREAM_H_
 ...
 * of @link genesis::utils::containers::Optional Optional@endlink Variant%s, with one Variant per input source.
 * If a source does not have data at the current locus,
 * the @link genesis::utils::containers::Optional Optional@endlink is empty.
 ...
 *         // Work directly with the std::vector<genesis::utils::containers::Optional<Variant>> opt_variant that is
...
public:
    ...
    enum class ContributionType
    {
         ...
         * @link genesis::utils::containers::Optional Optional@endlink be empty in the iterator at this locus.
         */
        kCarrying,
         ...
         * others (or has an empty @link genesis::utils::containers::Optional Optional@endlink Variant,
    ...
    public:
        ...
        using value_type        = std::vector<genesis::utils::containers::Optional<Variant>>;
    ...
    public:
        ...
        std::vector<genesis::utils::containers::Optional<Variant>> const * operator->() const
        {
            return &variants_;
        }

        std::vector<genesis::utils::containers::Optional<Variant>> * operator->()
        {
            return &variants_;
        }
         ...
         */
        std::vector<genesis::utils::containers::Optional<Variant>> const& variants() const
        {
            return variants_;
        }
         ...
         */
        std::vector<genesis::utils::containers::Optional<Variant>>& variants()
        {
            return variants_;
        }
         ...
         */
        genesis::utils::containers::Optional<Variant> const& variant_at( size_t index ) const
        {
         ...
         */
        genesis::utils::containers::Optional<Variant>& variant_at( size_t index )
        {
            // Return with boundary check.
            return variants_.at( index );
        }
    ...
    private:
        ...
        std::vector<genesis::utils::containers::Optional<Variant>> variants_;
     ...
     * @link genesis::utils::containers::GenericInputStream::add_transform() add_transform()@endlink,
     * @link genesis::utils::containers::GenericInputStream::add_filter() add_filter()@endlink, and
     * @link genesis::utils::containers::GenericInputStream::add_transform_filter() add_transform_filter()@endlink;
     * see genesis::utils::containers::GenericInputStream for details.
     */
