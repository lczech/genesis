...
public:
    ...
    private:
        ...
        std::vector<std::function<void(genesis::utils::io::InputStream&)>> column_processors_;
     ...
     */
    self_type& input_source( std::shared_ptr<genesis::utils::io::BaseInputSource> value )
    {
        input_source_ = value;
        return *this;
    }
