...
public:
     ...
     *
     * @copydetails BedReader::read_as_genome_region_list( std::shared_ptr< genesis::utils::io::BaseInputSource >, bool ) const
     */
...
private:
     ...
     */
    bool next_field_( genesis::utils::io::InputStream& input_stream, size_t& found_columns ) const;

    /**
     * @brief Parse a single string value, delimited from the next column by tabs or spaces.
     */
    std::string parse_string_( genesis::utils::io::InputStream& input_stream ) const;
