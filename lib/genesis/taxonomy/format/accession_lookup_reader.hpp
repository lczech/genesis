#ifndef GENESIS_TAXONOMY_FORMAT_ACCESSION_LOOKUP_READER_H_
#define GENESIS_TAXONOMY_FORMAT_ACCESSION_LOOKUP_READER_H_
...
public:
    ...
    AccessionLookupReader( Taxonomy& tax, std::shared_ptr<genesis::util::threading::ThreadPool> thread_pool )
    {
        fill_taxon_map_( tax );
    ...
    void read_with_column_positions(
        ...
        genesis::util::io::InputStream instream( source );
...
private:
    ...
    std::pair<size_t, size_t> get_table_header_column_positions_(
        genesis::util::io::InputStream& instream,
        ...
        auto const cols = genesis::util::text::split( header, separator_char_, false );
    ...
    Report read_table_(
        ...
        genesis::util::threading::ProactiveFuture<void> block_future;
        while( instream ) {
            ...
            for( size_t b = 0; b < block_size_; ++b ) {
                ...
                // Depending on the standard, we can use a view, which is cheaper.
                    ...
                    genesis::util::text::split_view( line, col_buffer, separator_char_, false );
                #else
                    auto const line = instream.get_line();
                    genesis::util::text::split( line, col_buffer, separator_char_, false );
                ...
                #if GENESIS_CPP_STD >= GENESIS_CPP_STD_17
                    auto const taxid = genesis::util::text::convert_from_chars<uint64_t>(
                        col_buffer[tid_pos]
                    );
                #else
    ...
    void process_block_concurrently_(
        ...
        genesis::util::threading::MultiFuture<void> futures( target.data().subcnt() );
