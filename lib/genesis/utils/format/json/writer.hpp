#ifndef GENESIS_UTILS_FORMAT_JSON_WRITER_H_
#define GENESIS_UTILS_FORMAT_JSON_WRITER_H_
...
public:
     ...
     */
    void write( JsonDocument const& document, std::shared_ptr< genesis::utils::io::BaseOutputTarget> target ) const;
