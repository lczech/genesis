#ifndef GENESIS_UTIL_TOOL_HASH_SHA1_H_
#define GENESIS_UTIL_TOOL_HASH_SHA1_H_
...
namespace std
{
     ...
     */
    template<>
    struct hash<genesis::util::SHA1::DigestType>
    {
        using argument_type = genesis::util::SHA1::DigestType;
