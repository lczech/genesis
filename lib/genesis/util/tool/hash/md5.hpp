#ifndef GENESIS_UTIL_TOOL_HASH_MD5_H_
#define GENESIS_UTIL_TOOL_HASH_MD5_H_
...
namespace std
{
     ...
     */
    template<>
    struct hash<genesis::util::MD5::DigestType>
    {
        using argument_type = genesis::util::MD5::DigestType;
