...
std::string CsvReader::parse_field( genesis::util::io::InputStream& input_stream ) const
{
...
std::vector<std::string> CsvReader::parse_line( genesis::util::io::InputStream& input_stream ) const
{
    using namespace genesis::util::io;
    using namespace genesis::util::text;
