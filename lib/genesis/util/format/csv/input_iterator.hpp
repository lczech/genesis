#ifndef GENESIS_UTIL_FORMAT_CSV_INPUT_ITERATOR_H_
#define GENESIS_UTIL_FORMAT_CSV_INPUT_ITERATOR_H_
...
public:
     ...
     */
    explicit CsvInputIterator( std::shared_ptr<genesis::util::io::BaseInputSource> source )
     ...
     */
    CsvInputIterator( std::shared_ptr<genesis::util::io::BaseInputSource> source, CsvReader const& settings )
        : input_stream_( std::make_shared<genesis::util::io::InputStream>( source ))
        , reader_( settings )
        , line_()
    {
