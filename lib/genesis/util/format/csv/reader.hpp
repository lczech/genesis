#ifndef GENESIS_UTIL_FORMAT_CSV_READER_H_
#define GENESIS_UTIL_FORMAT_CSV_READER_H_
...
public:
     ...
     */
    Table read( std::shared_ptr<genesis::util::io::BaseInputSource> source ) const;
