#ifndef GENESIS_UTIL_FORMAT_NEXUS_WRITER_H_
#define GENESIS_UTIL_FORMAT_NEXUS_WRITER_H_
...
public:
     ...
     */
    void write( NexusDocument const& document, std::shared_ptr< genesis::util::io::BaseOutputTarget> target ) const;
