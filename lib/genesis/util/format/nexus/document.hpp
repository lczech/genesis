#ifndef GENESIS_UTIL_FORMAT_NEXUS_DOCUMENT_H_
#define GENESIS_UTIL_FORMAT_NEXUS_DOCUMENT_H_
...
public:
    ...
    // {
    //     data_.push_back( genesis::util::core::make_unique<NexusBlock>(block) );
    // }
