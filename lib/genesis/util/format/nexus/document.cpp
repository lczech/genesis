...
//             bptr = genesis::util::core::make_unique<Trees>(trees);
//             return;
//         }
//     }
//     data_.push_back( genesis::util::core::make_unique<Trees>(trees) );
// }
//
// void NexusDocument::set_block_taxa( Taxa const& taxa )
// {
//     data_.push_back( genesis::util::core::make_unique<Taxa>(taxa) );
// }
