#ifndef GENESIS_UTIL_FORMAT_NEXUS_TAXA_H_
#define GENESIS_UTIL_FORMAT_NEXUS_TAXA_H_
...
public:
    ...
    {
        return genesis::util::core::contains( taxa_, name );
    }
...
public:
    ...
    {
        genesis::util::core::insert_sorted( taxa_, name );
    }
