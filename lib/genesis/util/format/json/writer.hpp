#ifndef GENESIS_UTIL_FORMAT_JSON_WRITER_H_
#define GENESIS_UTIL_FORMAT_JSON_WRITER_H_
...
public:
     ...
     */
    void write( JsonDocument const& document, std::shared_ptr< genesis::util::io::BaseOutputTarget> target ) const;
