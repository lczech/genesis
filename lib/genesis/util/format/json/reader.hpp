#ifndef GENESIS_UTIL_FORMAT_JSON_READER_H_
#define GENESIS_UTIL_FORMAT_JSON_READER_H_
...
public:
    ...
    using InputStream = genesis::util::io::InputStream;
     ...
     */
    JsonDocument read( std::shared_ptr<genesis::util::io::BaseInputSource> source ) const;
