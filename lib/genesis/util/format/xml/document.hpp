#ifndef GENESIS_UTIL_FORMAT_XML_DOCUMENT_H_
#define GENESIS_UTIL_FORMAT_XML_DOCUMENT_H_
...
public:
    ...
    {
        auto elm = genesis::util::core::make_unique<XmlComment>(comment);
        auto ptr = elm.get();
    ...
    {
        auto elm = genesis::util::core::make_unique<XmlMarkup>(text);
        auto ptr = elm.get();
        content.push_back(std::move(elm));
        return ptr;
    }
    ...
    {
        auto elm = genesis::util::core::make_unique<XmlElement>(tag_value);
        auto ptr = elm.get();
        content.push_back(std::move(elm));
        return ptr;
    }
