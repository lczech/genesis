#ifndef GENESIS_UTIL_FORMAT_XML_WRITER_H_
#define GENESIS_UTIL_FORMAT_XML_WRITER_H_
...
public:
    ...
    void write( XmlDocument const& document, std::shared_ptr< genesis::util::io::BaseOutputTarget> target ) const;
