#ifndef GENESIS_UTIL_FORMAT_SVG_MATRIX_H_
#define GENESIS_UTIL_FORMAT_SVG_MATRIX_H_
...
public:
    ...
    genesis::util::format::SvgText label_template;
...
SvgGroup make_svg_matrix(
    genesis::util::container::Matrix<genesis::util::color::Color> const& mat,
