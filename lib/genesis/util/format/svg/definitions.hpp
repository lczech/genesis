#ifndef GENESIS_UTIL_FORMAT_SVG_DEFINITIONS_H_
#define GENESIS_UTIL_FORMAT_SVG_DEFINITIONS_H_
...
public:
    ...
    SvgDefinitions( T const& object )
        : pimpl_( genesis::util::core::make_unique< Model<T> >( object ))
    {}
...
private:
    ...
    struct Model : Concept
    {
        ...
        std::unique_ptr< Concept > clone() const override
        {
            ...
            return genesis::util::core::make_unique< Model<T> >( object_ );
        }
