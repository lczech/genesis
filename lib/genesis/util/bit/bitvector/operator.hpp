#ifndef GENESIS_UTIL_BIT_BITVECTOR_OPERATOR_H_
#define GENESIS_UTIL_BIT_BITVECTOR_OPERATOR_H_
 ...
 */
genesis::util::io::Serializer& operator<<(
    genesis::util::io::Serializer& serializer,
    Bitvector const& bv
);
 ...
 */
genesis::util::io::Deserializer& operator>>(
...
{
    std::size_t operator() ( genesis::util::bit::Bitvector const& value ) const
    {
        return genesis::util::bit::bitvector_hash(value);
    }
};
 ...
 */
template<>
struct hash<genesis::util::bit::Bitvector>
{
    std::size_t operator() ( genesis::util::bit::Bitvector const& value ) const
    {
        return genesis::util::bit::bitvector_hash(value);
