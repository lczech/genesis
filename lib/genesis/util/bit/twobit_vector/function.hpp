#ifndef GENESIS_UTIL_BIT_TWOBIT_VECTOR_FUNCTION_H_
#define GENESIS_UTIL_BIT_TWOBIT_VECTOR_FUNCTION_H_
...
std::vector<T> kmer_occurrences( TwobitVector const& vec, size_t k )
{
    ...
    auto const res_size = math::int_pow( 4, k );
