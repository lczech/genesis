#ifndef GENESIS_UTIL_BIT_TWOBIT_VECTOR_ITERATOR_SUBSTITUTIONS_H_
#define GENESIS_UTIL_BIT_TWOBIT_VECTOR_ITERATOR_SUBSTITUTIONS_H_
 ...
 */
inline genesis::util::container::Range< IteratorSubstitutions > iterate_substitutions( TwobitVector const& vector )
{
    return {
