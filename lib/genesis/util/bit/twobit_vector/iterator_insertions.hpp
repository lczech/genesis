#ifndef GENESIS_UTIL_BIT_TWOBIT_VECTOR_ITERATOR_INSERTIONS_H_
#define GENESIS_UTIL_BIT_TWOBIT_VECTOR_ITERATOR_INSERTIONS_H_
 ...
 */
inline genesis::util::container::Range< IteratorInsertions > iterate_insertions( TwobitVector const& vector )
{
    return {
