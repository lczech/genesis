#ifndef GENESIS_UTIL_BIT_TWOBIT_VECTOR_ITERATOR_DELETIONS_H_
#define GENESIS_UTIL_BIT_TWOBIT_VECTOR_ITERATOR_DELETIONS_H_
 ...
 */
inline genesis::util::container::Range< IteratorDeletions > iterate_deletions( TwobitVector const& vector )
{
    return {
