#ifndef GENESIS_UTIL_CORE_RESOURCE_LOGGER_H_
#define GENESIS_UTIL_CORE_RESOURCE_LOGGER_H_
...
public:
    ...
    void log_to_file( std::string const& log_file, bool write_header = true )
    {
        ...
        genesis::util::io::file_output_stream( log_file, *target );
        log_to_sink(
...
private:
    ...
    {
        using genesis::util::text::to_string_byte_format;
