#ifndef GENESIS_UTIL_CORE_LOGGING_H_
#define GENESIS_UTIL_CORE_LOGGING_H_
...
// TODO offer remote streams
     ...
     */
#    define LOG_LEVEL_MAX genesis::util::core::Logging::kDebug4
#endif
...
#define GENESIS_LOG(level) \
    ...
    else if (level > genesis::util::core::Logging::max_level()) ; \
    else genesis::util::core::Logging().get(__FILE__, __LINE__, GENESIS_FUNC, level)

// define a similar log macro, this time changing the details of the message
#define GENESIS_LOG_DETAILS(level, ...) \
    if (level > LOG_LEVEL_MAX) ; \
    else if (level > genesis::util::core::Logging::max_level()) ; \
    else genesis::util::core::Logging().get(__FILE__, __LINE__, GENESIS_FUNC, level, {__VA_ARGS__})

// define standard logging types as macro shortcuts:

/** @brief Log an error. See genesis::util::core::LoggingLevel. */
#define LOG_ERR  GENESIS_LOG(genesis::util::core::Logging::kError)

/** @brief Log a warning. See genesis::util::core::LoggingLevel. */
#define LOG_WARN GENESIS_LOG(genesis::util::core::Logging::kWarning)

/** @brief Log an info message. See genesis::util::core::LoggingLevel. */
#define LOG_INFO GENESIS_LOG(genesis::util::core::Logging::kInfo)

/** @brief Log an info message. See genesis::util::core::LoggingLevel. */
#define LOG_MSG GENESIS_LOG(genesis::util::core::Logging::kMessage)

/** @brief Log an info message. See genesis::util::core::LoggingLevel. */
#define LOG_MSG1 GENESIS_LOG(genesis::util::core::Logging::kMessage1)

/** @brief Log an info message. See genesis::util::core::LoggingLevel. */
#define LOG_MSG2 GENESIS_LOG(genesis::util::core::Logging::kMessage2)

/** @brief Log an info message. See genesis::util::core::LoggingLevel. */
#define LOG_MSG3 GENESIS_LOG(genesis::util::core::Logging::kMessage3)

/** @brief Log an info message. See genesis::util::core::LoggingLevel. */
#define LOG_MSG4 GENESIS_LOG(genesis::util::core::Logging::kMessage4)

/** @brief Log a debug message. See genesis::util::core::LoggingLevel. */
#define LOG_DBG  GENESIS_LOG(genesis::util::core::Logging::kDebug)

/** @brief Log a debug message. See genesis::util::core::LoggingLevel. */
#define LOG_DBG1 GENESIS_LOG(genesis::util::core::Logging::kDebug1)

/** @brief Log a debug message. See genesis::util::core::LoggingLevel. */
#define LOG_DBG2 GENESIS_LOG(genesis::util::core::Logging::kDebug2)

/** @brief Log a debug message. See genesis::util::core::LoggingLevel. */
#define LOG_DBG3 GENESIS_LOG(genesis::util::core::Logging::kDebug3)

/** @brief Log a debug message. See genesis::util::core::LoggingLevel. */
#define LOG_DBG4 GENESIS_LOG(genesis::util::core::Logging::kDebug4)
 ...
 * termination.
 */
#define LOG_BOLD GENESIS_LOG_DETAILS(genesis::util::core::Logging::kNone, \
 ...
 */
#define LOG_TIME GENESIS_LOG_DETAILS(genesis::util::core::Logging::kDebug, \
...
#define LOG_SCOPE_LEVEL(level) \
    genesis::util::core::LoggingScopeLevel genesis_logging_scope_level_temp_object(level);
...
#define LOG_PROG( value, quantity ) \
    if( genesis::util::core::Logging::kProgress > LOG_LEVEL_MAX ) ; \
    else if( genesis::util::core::Logging::kProgress > genesis::util::core::Logging::max_level() ) ; \
    else if( (long) genesis::util::logging_progress_value(value) % \
        (((long) (quantity) * genesis::util::core::Logging::report_percentage() / 100) > 0 ? \
        ((long) (quantity) * genesis::util::core::Logging::report_percentage() / 100) : 1) != 0 ) ; \
    else genesis::util::core::Logging().get(__FILE__, __LINE__, GENESIS_FUNC, genesis::util::core::Logging::kProgress) << \
    (int) round(100.0 * (double) genesis::util::logging_progress_value() / ((quantity) > 0 ? (quantity) : 1)) << "% "
