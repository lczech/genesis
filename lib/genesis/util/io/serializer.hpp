#ifndef GENESIS_UTIL_IO_SERIALIZER_H_
#define GENESIS_UTIL_IO_SERIALIZER_H_
...
inline typename std::enable_if<
    !genesis::util::core::is_container<T>::value, Serializer&
>::type
...
inline typename std::enable_if<
    genesis::util::core::is_container<Container>::value, Serializer&
>::type
