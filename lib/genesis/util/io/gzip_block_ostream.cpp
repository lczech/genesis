...
private:
    ...
    template<class T>
    using ProactiveFuture = genesis::util::threading::ProactiveFuture<T>;
    using ThreadPool      = genesis::util::threading::ThreadPool;
...
public:
    ...
    GzipBlockOStreambuf(
        ...
        , thread_pool_(
            thread_pool
            ? thread_pool
            : genesis::util::core::Options::get().global_thread_pool()
        )
    {
