#ifndef GENESIS_UTIL_IO_INPUT_SOURCE_H_
#define GENESIS_UTIL_IO_INPUT_SOURCE_H_
...
inline std::shared_ptr<BaseInputSource> from_file(
    ...
    if( detect_compression && is_gzip_compressed_file( file_name )) {
        return std::make_shared<genesis::util::io::GzipInputSource>(
 ...
 * This function can for example be used with the output of genesis::util::dir_list_files().
 *
