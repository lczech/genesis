#ifndef GENESIS_UTIL_IO_GZIP_OUTPUT_TARGET_H_
#define GENESIS_UTIL_IO_GZIP_OUTPUT_TARGET_H_
...
private:
    ...
    std::ostream& out_stream_() override
    {
        ...
        if( !stream_ ) {
            ...
            stream_ = genesis::util::core::make_unique<GzipOStream>(
...
private:
    ...
    std::ostream& out_stream_() override
    {
        ...
        if( !stream_ || !stream_->good() ) {
            ...
            // in order to avoid ambiguous overload when compiled with C++17.
            stream_ = genesis::util::core::make_unique<GzipBlockOStream>(
