#ifndef GENESIS_UTIL_IO_DESERIALIZER_H_
#define GENESIS_UTIL_IO_DESERIALIZER_H_
...
public:
    ...
    explicit Deserializer( std::shared_ptr<genesis::util::io::BaseInputSource> input_source )
    ...
    */
    ...
    template <typename T>
    inline
    typename std::enable_if<genesis::util::core::is_container<T>::value>::type
    get( T& container )
    {
        size_t size = 0;
        get( size );
    ...
    template <typename T>
    inline
    typename std::enable_if<genesis::util::core::is_container<T>::value, T>::type
    get()
    {
        T container;
        get( container );
 ...
 */
template <typename T>
inline typename std::enable_if<!genesis::util::core::is_container<T>::value, Deserializer&>::type
...
inline typename std::enable_if<
    genesis::util::core::is_container<Container>::value &&
    genesis::util::core::has_reserve<Container>::value, Deserializer&
>::type
