#ifndef GENESIS_UTIL_CONTAINER_MATRIX_READER_H_
#define GENESIS_UTIL_CONTAINER_MATRIX_READER_H_
...
public:
    ...
    using CsvReader = genesis::util::format::CsvReader;
    using BaseInputSource = genesis::util::io::BaseInputSource;
