#ifndef GENESIS_UTIL_CONTAINER_DATAFRAME_READER_H_
#define GENESIS_UTIL_CONTAINER_DATAFRAME_READER_H_
...
public:
    ...
    explicit DataframeReader( genesis::util::format::CsvReader const& reader )
        : reader_( reader )
    {}
    ...
    genesis::util::format::CsvReader const& csv_reader() const
    {
        return reader_;
    }
...
private:
    ...
    genesis::util::format::CsvReader reader_;
