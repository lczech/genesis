#ifndef GENESIS_UTIL_CONTAINER_TRANSFORM_ITERATOR_H_
#define GENESIS_UTIL_CONTAINER_TRANSFORM_ITERATOR_H_
...
public:
    ...
    using result_type = typename genesis::util::core::genesis_invoke_result<
