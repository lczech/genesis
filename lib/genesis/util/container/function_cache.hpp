#ifndef GENESIS_UTIL_CONTAINER_FUNCTION_CACHE_H_
#define GENESIS_UTIL_CONTAINER_FUNCTION_CACHE_H_
...
public:
    ...
    // See genesis/util/containers/hash_tuple.hpp for details.
    using container_type  = std::unordered_map<
        key_type, value_type, genesis::util::container::hash<key_type>
    >;
...
public:
        ...
        : load_function_( load_function )
    {
        ...
        for( size_t i = 0; i < shards; ++i ) {
            ...
            shards_.push_back( genesis::util::core::make_unique<Shard>() );
        }
    }
...
private:
    ...
    {
        return genesis::util::container::hash<key_type>{}( key ) % shards_.size();
    }
