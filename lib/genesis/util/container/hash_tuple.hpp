#ifndef GENESIS_UTIL_CONTAINER_HASH_TUPLE_H_
#define GENESIS_UTIL_CONTAINER_HASH_TUPLE_H_
...
namespace
{
    ...
    struct HashValueImpl
    {
        static void apply( size_t& seed, Tuple const& tuple )
        {
            ...
            seed = genesis::util::core::hash_combine( seed, std::get<Index>( tuple ));
        }
    };
    ...
    struct HashValueImpl<Tuple,0>
    {
        static void apply( size_t& seed, Tuple const& tuple )
        {
            seed = genesis::util::core::hash_combine( seed, std::get<0>( tuple ));
        }
    };
}
