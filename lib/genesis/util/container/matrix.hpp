#ifndef GENESIS_UTIL_CONTAINER_MATRIX_H_
#define GENESIS_UTIL_CONTAINER_MATRIX_H_
...
genesis::util::io::Deserializer& operator>>(
    genesis::util::io::Deserializer&, genesis::util::container::Matrix<T>&
);
...
public:
    ...
    friend genesis::util::io::Deserializer& operator>><>(
        genesis::util::io::Deserializer&, Matrix<T>&
    );
