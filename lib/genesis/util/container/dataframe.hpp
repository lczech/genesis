#ifndef GENESIS_UTIL_CONTAINER_DATAFRAME_H_
#define GENESIS_UTIL_CONTAINER_DATAFRAME_H_
...
public:
    ...
    using       iterator  = genesis::util::container::DereferenceIterator< container_type::iterator >;
    using const_iterator  = genesis::util::container::DereferenceIterator< container_type::const_iterator >;
     ...
     *
     * Located in genesis/util/containers/dataframe/operators.hpp
     */
