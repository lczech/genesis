#ifndef GENESIS_UTIL_CONTAINER_GENERIC_INPUT_STREAM_H_
#define GENESIS_UTIL_CONTAINER_GENERIC_INPUT_STREAM_H_
 ...
 *     auto it = SimplePileupInputIterator( genesis::util::io::from_file( pileup_file_.value ), reader );
 *     auto generator = GenericInputStream<Variant>(
...
public:
    ...
    public:
        ...
        template<typename U>
        using ProactiveFuture = genesis::util::threading::ProactiveFuture<U>;
    ...
    /**
     * @copydoc GenericInputStream( std::function<bool(value_type&)>, std::shared_ptr<genesis::util::threading::ThreadPool>, size_t )
     *
    ...
    /**
     * @copydoc GenericInputStream( std::function<bool(value_type&)>, Data const&, std::shared_ptr<genesis::util::threading::ThreadPool>, size_t )
     *
     ...
     */
    self_type& thread_pool( std::shared_ptr<genesis::util::threading::ThreadPool> value )
    {
        if( has_started_ ) {
            throw std::runtime_error(
