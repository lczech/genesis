#ifndef GENESIS_UTIL_COLOR_MAP_H_
#define GENESIS_UTIL_COLOR_MAP_H_
...
public:
    ...
    explicit ColorMap( std::vector<Color> const& colors )
    {
        palette( colors );
    }
     ...
     * @link BmpWriter::write( Matrix<unsigned char> const&, std::vector<Color> const&, std::shared_ptr< genesis::util::io::BaseOutputTarget> ) const BmpWriter::to_file()@endlink.
     *
