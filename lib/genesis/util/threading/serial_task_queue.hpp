#ifndef GENESIS_UTIL_THREADING_SERIAL_TASK_QUEUE_H_
#define GENESIS_UTIL_THREADING_SERIAL_TASK_QUEUE_H_
...
public:
    ...
    -> ProactiveFuture<typename genesis::util::core::genesis_invoke_result<F, Args...>::type>
    {
        // Deduce the return type of the function.
        using result_type = typename genesis::util::core::genesis_invoke_result<F, Args...>::type;
