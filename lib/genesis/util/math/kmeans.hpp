#ifndef GENESIS_UTIL_MATH_KMEANS_H_
#define GENESIS_UTIL_MATH_KMEANS_H_
...
protected:
    ...
    virtual bool assign_to_centroids(
        ...
        genesis::util::threading::parallel_for( 0, data.size(), [&]( size_t i )
        {
...
private:
    ...
    void init_with_kmeans_plus_plus_(
        ...
        for( size_t i = 1; i < k; ++i ) {
            ...
            // For each data point...
            genesis::util::threading::parallel_for( 0, data.size(), [&]( size_t di )
            {
