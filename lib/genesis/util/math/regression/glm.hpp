#ifndef GENESIS_UTIL_MATH_REGRESSION_GLM_H_
#define GENESIS_UTIL_MATH_REGRESSION_GLM_H_
...
struct GlmOutput
{
     ...
     */
    genesis::util::container::Matrix<double> Xb;
 ...
 */
GlmOutput glm_fit(
    genesis::util::container::Matrix<double> const&      x_predictors,
