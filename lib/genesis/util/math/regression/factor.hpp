#ifndef GENESIS_UTIL_MATH_REGRESSION_FACTOR_H_
#define GENESIS_UTIL_MATH_REGRESSION_FACTOR_H_
 ...
 */
template<class T>
genesis::util::container::Dataframe glm_indicator_variables(
    ...
    genesis::util::container::Dataframe result;
    if( row_names.empty() ) {
