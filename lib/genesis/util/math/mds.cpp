...
/*
    ...
    We adapted the implementation to our genesis::util::container::Matrix class and changed the error reporting
...
static genesis::util::container::Matrix<double> multi_dimensional_scaling_ucf(
    ...
    for( size_t j = 0; j < perms.cols(); ++j ) {
        auto& rand_eng = genesis::util::core::Options::get().random_engine();
...
static genesis::util::container::Matrix<double> multi_dimensional_scaling_smacof(
    genesis::util::container::Matrix<double> const& distances,
    genesis::util::container::Matrix<double> const& initial_values,
    size_t                dimensions,
    size_t                iterations
...
genesis::util::container::Matrix<double> multi_dimensional_scaling(
    ...
    auto& engine = genesis::util::core::Options::get().random_engine();
