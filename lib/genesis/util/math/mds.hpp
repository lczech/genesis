#ifndef GENESIS_UTIL_MATH_MDS_H_
#define GENESIS_UTIL_MATH_MDS_H_
 ...
 *
 * @see @link multi_dimensional_scaling( genesis::util::container::Matrix<double> const&, genesis::util::container::Matrix<double> const&, size_t, size_t, MdsAlgorithm ) multi_dimensional_scaling()@endlink
 * for details on the function, its parameters, and the license of the implementation.
 */
genesis::util::container::Matrix<double> multi_dimensional_scaling(
    genesis::util::container::Matrix<double> const& distances,
    size_t                dimensions = 2,
 ...
 * See @link multi_dimensional_scaling( genesis::util::container::Matrix<double> const&, size_t, size_t, MdsAlgorithm ) multi_dimensional_scaling()@endlink
 ...
 * We adapted the implementation to our @link genesis::util::container::Matrix Matrix@endlink class and
...
genesis::util::container::Matrix<double> multi_dimensional_scaling(
    genesis::util::container::Matrix<double> const& distances,
    genesis::util::container::Matrix<double> const& initial_values,
    size_t                dimensions = 2,
    size_t                iterations = 100,
    MdsAlgorithm          algorithm = MdsAlgorithm::kUcf
);
