#ifndef GENESIS_UTIL_MATH_HISTOGRAM_ACCUMULATOR_H_
#define GENESIS_UTIL_MATH_HISTOGRAM_ACCUMULATOR_H_
...
public:
    ...
    explicit HistogramAccumulator (const std::vector<double>& values, double weight = 1.0);

    explicit HistogramAccumulator (const std::vector<std::pair<double,double>>& weighted_values);
