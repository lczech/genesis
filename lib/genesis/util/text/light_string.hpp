#ifndef GENESIS_UTIL_TEXT_LIGHT_STRING_H_
#define GENESIS_UTIL_TEXT_LIGHT_STRING_H_
...
public:
     ...
     */
    LightString()
        : data_( ::genesis::util::core::make_unique<char[]>( 1 ))
    {
        data_[0] = '\0';
    }
    ...
    explicit LightString( char const* str )
    {
        if( str ) {
            ...
            data_ = ::genesis::util::core::make_unique<char[]>(len + 1);
...
inline LightString operator+( LightString const& lhs, LightString const& rhs )
{
    ...
    auto buffer = ::genesis::util::core::make_unique<char[]>(new_size + 1);
...
namespace std
{
     ...
     */
    template<>
    struct hash<::genesis::util::text::LightString>
    {
        inline std::size_t operator()( ::genesis::util::text::LightString const& ls ) const noexcept
        {
    ...
    struct hash<::genesis::util::text::LightString>
    {
        std::size_t operator()( ::genesis::util::text::LightString const& ls ) const
        {
